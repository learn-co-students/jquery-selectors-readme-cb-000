describe('Selectors', () => {
  ...
  it('lastImageSelector() should return the last image', function() {
    ...
    expect(lastImageSelector().attr('src')).toEqual(
  ...
  it('ninjaBabySelector() should return the image of the ninja baby', function() {
    ...
    expect(ninjaBabySelector().attr('src')).toEqual(
      'https://s3.amazonaws.com/after-school-assets/baby-ninja.gif'
    )
  })
  ...
  it('firstListItem() should return the first list item in the unordered list', function() {
    ...
    expect(firstListItem()[0].children[0].src).toEqual(
      'https://s3.amazonaws.com/after-school-assets/awesome.jpg'
    )
  })
})
